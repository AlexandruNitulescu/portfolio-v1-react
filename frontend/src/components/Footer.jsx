...
const Footer = () => {
  return (
    <footer class="border-t-2 border-gray-200">
        <div class="mt-8 max-w-7xl mx-auto p-4 md:flex md:items-center md:justify-between ">
          <span class="text-sm text-white sm:text-center ">© 2023 <a href="#" class="hover:underline">Alexandru Nitulescu</a>. All Rights Reserved.</span>
